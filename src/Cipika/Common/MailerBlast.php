...
class MailerBlast
{
    ...
    function save($data)
    {
        ...
        $CI->db->insert('mailer_blast',$insert); 
    ...
    function update($id, $data)
    {
        ...
        $CI->db->update('mailer_blast', $data);
    ...
    function getEmails($limit=5)
    {
        ...
        $sql = "select * from mailer_blast where mailer_status='new' and mailer_created<'$now' order by mailer_created asc limit 0,$limit";
    ...
    {
        $CI =& get_instance();  
        $sql = "select * from mailer_blast where idmailer=". (int)$idmailer." limit 0,1";
