...
class CI_DB_pdo_driver extends CI_DB {
    ...
    // Workaround : because PDO mysql doesn't escape identifier properly
    // This causes error on API mobile where it try to access keys table
	var $_escape_char = '`';
	...
	function db_connect()
	{
        if (isset($this->params['PDO::ATTR_ERRMODE'])) {
            $this->options['PDO::ATTR_ERRMODE'] = $this->params['PDO::ATTR_ERRMODE'];
        } else {
