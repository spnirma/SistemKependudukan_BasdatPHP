        ...
        success: function (response)
        {
            try {
                ...
                if (data.status == 0) {
                    ...
                    $("#formGantiAlamatAjax").modal("hide");
        ...
        success: function (response)
        {
            try {
                ...
                if (data.status == 0) {
                    ...
                    $("#formGantiNomorTujuanAjax").modal("hide");
                    window.location.href = data.url;
                }
            } catch (e) {
                alert('Terjadi masalah saat proses penggantian alamat');
...
$('#reset-code-voucher').click(function () {
...
$('#confirm-code-voucher').click(function () {
    var codeVoucher = $("#kode_voucher").val();
    $.ajax({
...
function update_ongkir(idKeyMerchant)
{
    ...
    $.ajax({
        ...
        data: "idOngkir=" + id_ongkir + "&idMerchant=" + idKeyMerchant,
...
$('#reset-point-user').click(function () {
    var pointUser = $("#poin_input_user").val();
    alert("point ; " + pointUser);
    $.ajax({
