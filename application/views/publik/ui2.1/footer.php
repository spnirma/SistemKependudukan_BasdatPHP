<footer id="foot">
          <div class="container">
            <div class="row">
                ...
                <div class="col-xs-2">
                    <h6>Follow Us</h6>
                    <ul class="socmed">
                        <li><a href="https://www.facebook.com/pages/Cipika-Store/466418886820641"><img alt="Facebook" src="<?=base_url()?>asset/img/facebook.png" class="social-media-btn"></a></li>
                        <li><a href="https://twitter.com/Cipika_ID"><img alt="Twitter" src="<?=base_url()?>asset/img/twitter.png" class="social-media-btn"></a></li>
                        <!-- <li><a href="#"><img alt="Google+" src="<?=base_url()?>asset/ui2.1/img/icon-g.png"></a></li> -->
                    </ul>
                </div>
                <div class="col-xs-3">
            ...
            <div class="copyright">
                <div id="totop-responsive" class="ir">To Top</div>
                <p>www.cipika.co.id. 2015 PT Indosat Tbk. All rights reserved</p>
            </div>
        ...
        <script src="<?=base_url()?>asset/ui2.1/js/bootstrap.min.js"></script>

        <script type="text/javascript" src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
        <script type="text/javascript" src="http://code.jquery.com/jquery-migrate-1.2.1.min.js"></script>
        <script src="<?=base_url()?>asset/ui2.1/js/slick/slick.min.js"></script>
        <script src="<?=base_url()?>asset/ui2.1/js/main.js"></script>

        <!-- Slidebars -->
        <script src="<?=base_url()?>asset/ui2.1/js/slidebars.js"></script>
        <script>
            (function($) {
        ...
        <script src="<?=base_url()?>asset/ui2.1/js/slick/slick.min.js"></script>
        <script src="<?=base_url()?>asset/ui2.1/js/main.js"></script>
        <script src="<?=base_url()?>asset/ui2.1/js/checkout-page.js"></script>
        <script src="<?=base_url()?>asset/ui2.1/js/jquery.ddslick.min.js"></script>
