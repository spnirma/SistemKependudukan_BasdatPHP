...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="stylesheet" href="<?=base_url()?>asset/ui2.1/css/bootstrap.css">
        <link rel="stylesheet" href="<?=base_url()?>asset/ui2.1/css/main.css">
        <link rel="stylesheet" href="<?=base_url()?>asset/ui2.1/js/slick/slick.css">
        <link rel="stylesheet" href="<?=base_url()?>asset/ui2.1/css/custom.css">
        <script src="<?=base_url()?>asset/ui2.1/js/jquery-1.11.2.min.js"></script>
        ...
        <!-- MENU RESPONSIVE -->
        <link rel="stylesheet" href="<?=base_url()?>asset/ui2.1/css/slidebars.css">
        <link rel="stylesheet" href="<?=base_url()?>asset/ui2.1/css/example-styles.css">
    ...
    <div class="sb-slidebar sb-left">
        <div class="feature-responsive">
            <img src="<?=base_url()?>asset/ui2.1/img/cipika-logo.png"/>
            <table>
                <tr>
                    <td><img src="<?=base_url()?>asset/ui2.1/img/cart-rev.png" alt="Keranjang Belanja Kamu"></td>
                    <td><h2>Rp 20.000</h2></td>
                    <!-- Masalah : Jumlah duitnya atau jumlah item-->
                </tr>
            </table>
        </div>
        ...
        <ul class="main-nav-responsive">
            ...
            <li><a href="<?=base_url()?>gadget">Gadget</a></li>
            <li><a href="<?=base_url()?>food">Food</a></li>
            <li><a href="<?=base_url()?>lifestyle">Lifestyle</a></li>
        </ul>
    </div>

    <div id="sb-site">
        <div class="nav-responsive">
            <div class="nav-responsive-left">
                <ul>
                    <li class="sb-toggle-left bg-nav-responsive">&nbsp;&nbsp;</li>
                </ul>
            </div>
            <div class="nav-responsive-center">
                <a href="<?=base_url()?>"><img src="<?=base_url()?>asset/ui2.1/img/cipika-logo.png"/></a>
            </div>
            <div class="nav-responsive-right">
                <ul>
                    <li>
                        <a href="<?=base_url()?>cart"><span class="shopping-item"><?=$this->cart->total_items()?></span> <img src="<?=base_url()?>asset/ui2.1/img/cart-rev.png" alt="Keranjang Belanja Kamu" /></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <header id="head">
              <div class="navbar-main clearfix">
                <nav class="navbar-content container cpk-container-ex">
                  <ul class="nav navbar-nav nav-top-responsive">
                    <li>
                      <a class="ir mm-logo" href="<?=base_url()?>"><h1 class="site-name hidden">Cipika</h1></a>
                    </li>
                    <li <?=$uriChannel=='gadget' ? 'class="active"' : '' ?>>
                      <a id="lg-navbar-gadget" class="ir mm-gadget channel-menu" href="<?=base_url()?>gadget"><div class="channel-lable" style="padding-left: 5px;">Gadget</div></a>
                    </li>
                    <li <?=$uriChannel=='food' ? 'class="active"' : '' ?>>
                      <a id="lg-navbar-food" class="ir mm-store channel-menu" href="<?=base_url()?>food"><div class="channel-lable" style="padding-left: 15px;">Food</div></a>
                    </li>
                    <li <?=$uriChannel=='lifestyle' ? 'class="active"' : '' ?>>
                      <a id="lg-navbar-lifestyle" class="ir mm-lifestyle channel-menu" href="<?=base_url()?>lifestyle"><div class="channel-lable" style="padding-right: 7px;  margin-left: 5px;">Lifestyle</div></a>
                    </li>
                    <li>
                      <a id="lg-navbar-travel" class="ir mm-travel channel-menu" href="<?=base_url()?>travel"><div class="channel-lable" style="padding-left: 14px;">Travel</div></a>
                    </li>
                  </ul>
                </nav>
              </div><!-- /.navbar-main -->
                  ...
                  <div class="container cpk-container-ex clearfix">
                    <div class="force-right">
                        <nav class="navbar-content">
                          <ul class="nav navbar-nav nav-feature">
                            <li class="sm-search">
                                <?php
                            ...
                            <li class="sm-indosat li-responsive2">
