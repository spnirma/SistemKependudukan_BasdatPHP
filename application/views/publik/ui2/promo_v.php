...
?>
        <section class="main">
            ...
            <header class="content-head container">
                <div class="attribut-set clearfix">
                    <div class="category-setting force-right">
                        ...
                        <div>
                            ...
                            ?>
                            <form action="<?=base_url().$uriChannel.'/'.$id_promo.'/'.$id_promo = $this->uri->segment(3,'').'/?'.$query?>" method="POST">
                ...
                <?php if(!empty($tnc)){ ?>
                   <div class="row">
                    <div class="xs-col-9" style="padding:7px;">
                        <div class="panel panel-warning">
                        <div class="panel-heading tnc-heading" style="color: #fff;background-color: #fcaf16; cursor:pointer;">
                          <h3 class="panel-title" style="text-align:center">
                              Baca Syarat Dan Ketentuan Di Sini 
                                <img src="<?=base_url()?>/asset/new/img/arrow-down-white.png" style="float:right" class="tnc-arrow-down">
                                <img src="<?=base_url()?>/asset/new/img/arrow-up-white.png" style="float:right;display:none;" class="tnc-arrow-up">
                          </h3>
                        </div>
                        <div class="panel-body tnc-paragraph" style="display:none;"><?=$tnc?></div>
                      </div>
                    </div>
                    </div>
                <?php } ?>
...
<script>
    $(".tnc-heading").click(function(){
        if($(".tnc-paragraph").is(":visible")){
            $(".tnc-arrow-up").hide();
            $(".tnc-arrow-down").show();
            $(".tnc-paragraph").slideUp();
        } else {
            $(".tnc-arrow-up").show();
            $(".tnc-arrow-down").hide();
            $(".tnc-paragraph").slideDown();
        }
    });
    $(".tnc-arrow-down").click(function(e){
        $(".tnc-arrow-up").show();
        $(".tnc-arrow-down").hide();
        $(".tnc-paragraph").slideDown();
        e.stopPropagation();
    });
    $(".tnc-arrow-up").click(function(e){
        $(".tnc-arrow-up").hide();
        $(".tnc-arrow-down").show();
        $(".tnc-paragraph").slideUp();
        e.stopPropagation();
