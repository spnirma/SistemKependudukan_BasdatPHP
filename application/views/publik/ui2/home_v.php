...
<section class="banner" role="banner">            
              <div class="carousel" role="listbox">
                <div class="item">
                  <a href="http://bit.ly/1GQlK3K"><img src="<?=base_url()?>asset/new/banner/20150508/banner-promo-lumia.png" style="width: 1353px;" alt="Promo Lumia Mei 2015"></a>
                </div>
                <div class="item">
                  <a href="https://cipika.co.id/gadget"><img src="<?=base_url()?>asset/new/banner/20150506/banner-cipika-gadget.png" style="width: 1353px;" alt="Cipika Gadget"></a>
                </div>
                <div class="item">
                  <a href="https://cipika.co.id/gadget?cat=74&page=1"><img src="<?=base_url()?>asset/ui2/content/banner/Gadget_banner.png" style="width: 1353px;" alt="iPhone 6"></a>
                </div>
              </div>
