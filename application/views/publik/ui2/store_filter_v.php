            ...
            ?>
                ...
                <div class="boxhead">
                   <div class="row">
                       ...
                       <div class="col-xs-9">
                           Produk dari merchant  <?=htmlspecialchars($store_name)?>
                       </div>
                   </div> 
                </div>
            </header>
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <div class="side-filter lined category-filter">
                            <h4>Kategori</h4>
                            <?=$this->home_ui2_m->kategori_menu_generator();?>
                        </div>
                        <div class="side-filter lined category-filter">
                            <h4>Harga</h4>
                            <ul>
                        ...
                        <div class="side-filter">
                            <div class="side-filter-item category-filter kota-list">
                                <h4 style="margin-top:10px;">Kota</h4>
