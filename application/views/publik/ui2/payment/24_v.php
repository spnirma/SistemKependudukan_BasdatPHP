...
<div class="row">
	<div class="form-group text-only" >
		...
		<div class="col-sm-9">
			<input readonly value="<?= $mobo_outlet->mbo_number?>" type="text" class="form-control phone-user" id="mobo-number" name="mobo_number" value="" onkeypress="return checkFieldOnlyNumber(event)">
			<input readonly value="<?= $mobo_outlet->mbo_outlet_id?>" type="hidden" class="form-control phone-user" id="mobo-outlet-id" name="mobo_outlet_id" value="" onkeypress="return checkFieldOnlyNumber(event)">
		</div>
	</div>
</div>
<br>
