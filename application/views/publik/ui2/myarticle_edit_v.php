                            ...
                            <?php } ?>
                              ...
                              <form class="form-horizontal" method="post" action="">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-9">
                                    <input value="<?= htmlspecialchars($article->title);?>" name="title" type="text" class="form-control" id="nama_produk" placeholder="">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label for="" class="col-lg-2 control-label">Content</label>
                                  <div class="col-lg-4">
                                    <textarea name="content" class="form-control" id="deskripsi" placeholder="" rows=5><?= htmlspecialchars($article->content) ?></textarea>
                                  </div>
                                </div>
                                <div class="form-group">
