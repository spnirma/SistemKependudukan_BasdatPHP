...
var speakers = {
	"talks": "[{\"name\":\"Benson Putra\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/benson-putra.jpg\"},	{\"name\":\"Raisa Andriana\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/raisa.jpg\"},	{\"name\":\"Yeri Afriyani\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/yeri-calla.jpg\"},	{\"name\":\"Kukuh Rizal Arfianto\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/kukuh-rizal.jpg\"},	{\"name\":\"Timothy Ronald\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/timothy-ronald.jpg\"},	{\"name\":\"Muhammad Eddy Zaidy\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/muhammad-eddy-zaidy-scaled.jpg\"},	{\"name\":\"Christine Laifa\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/christine-laifa.jpg\"},	{\"name\":\"Arki Prizananda\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/arki-prizananda.jpg\"},	{\"name\":\"Rowland Asfales\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/rowland-asfales.jpg\"},	{\"name\":\"Nyonya Destira\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/nyonya-destira.jpg\"},	{\"name\":\"Najla Bisyir\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/najla-bisyir.jpg\"},	{\"name\":\"Meiske Taurisia\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/meiske-taurisia.jpg\"},	{\"name\":\"Kevindra Soemantri\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/kevindra-soemantri.jpg\"},	{\"name\":\"Ketut Saguna Narayana\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/ketut-saguna-narayana.jpg\"},	{\"name\":\"Keenan Pearce\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/keenan-pearce.jpg\"},	{\"name\":\"Edwin\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/edwin.jpg\"},	{\"name\":\"Daniel Surya\",\"featured_image\":\"https://ideafest.id/wp-content/uploads/2020/10/daniel-surya.jpg\"}]",
	"conference": "[]",
	"music": "[]"
};
(function ($) {
	talks_speakers = JSON.parse(speakers.talks);
	talks_speakers.sort(function (a, b) {
	...
	if ($('.page-id-66').length) {
		$(document).ready(function () {
			$('.speakers-default .speaker__item').each(function () {
				$(this).find('.speaker__container').css('background-image', 'url("' + talks_speakers[speakerIndex].featured_image + '")');
				$(this).find('.speaker__name').html(talks_speakers[speakerIndex].name);
				speakerIndex++
			})
			talks_ar_index = [];
			talks_ar_container_index = [];
			for (i = 0; i < talks_speakers.length; i++) {
				talks_ar_index[i] = i
			}
			talks_ar_index.sort(function () {
				return Math.random() - 0.5
			});
			for (i = 0; i < $('.speakers-flip .speaker__item').length; i++) {
				talks_ar_container_index[i] = i
			}
			talks_ar_container_index.sort(function () {
				return Math.random() - 0.5
			});
			talks_loop_index = 0;
			$('.speakers-flip .speaker__item .speaker__side--front').each(function () {
				$(this).css('background-image', 'url("' + talks_speakers[talks_ar_index[talks_loop_index]].featured_image + '")');
				$(this).find('.speaker__name').html(talks_speakers[talks_ar_index[talks_loop_index]].name);
				talks_loop_index++;
				if (talks_loop_index >= talks_speakers.length) {
					talks_loop_index = 0
				}
			});
			setInterval(function () {
				$speakerItem = $('.speakers-flip .speaker__item').eq(talks_ar_container_index[talks_loop_index % $('.speakers-flip .speaker__item').length]);
				$speakerItem.find('.speaker__side').each(function () {
				...
				$speakerItem.find('.speaker__box').toggleClass('flip')
			}, 3000);
			$('#home-fb-owl').owlCarousel({
				responsive: {
					0: {
						items: 2,
					},
...
jQuery('.c-text-l').attr({
	'data-aos-enable': 'true',
	'data-aos': 'fade-up',
	'data-aos-easing': 'ease-in-out',
});
jQuery('.about__title').attr({
	'data-aos-enable': 'true',
	'data-aos': 'fade-up',
});
AOS.init({})
